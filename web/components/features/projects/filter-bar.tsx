...
export function FilterBar({
  ...
  const visibleTechTags = showAllTech ? TECHNOLOGY_TAGS : TECHNOLOGY_TAGS.slice(0, 6)
  const visibleCategoryTags = showAllCategory ? CATEGORY_TAGS : CATEGORY_TAGS.slice(0, 6)
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {TECHNOLOGY_TAGS.length > 6 && (
              ...
              >
                {showAllTech ? "Show Less" : `+${TECHNOLOGY_TAGS.length - 6} More`}
              </Button>
            )}
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {CATEGORY_TAGS.length > 6 && (
              <Button
                ...
                className="text-blue-600 hover:text-blue-800"
              >
                {showAllCategory ? "Show Less" : `+${CATEGORY_TAGS.length - 6} More`}
              </Button>
            )}
          </div>
        </div>
